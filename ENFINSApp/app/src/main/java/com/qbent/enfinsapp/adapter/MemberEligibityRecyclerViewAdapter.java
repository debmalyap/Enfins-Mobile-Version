...
public class MemberEligibityRecyclerViewAdapter extends RecyclerView.Adapter<MemberEligibityRecyclerViewAdapter.MemberEligibityViewHolder>
{
    private final List<MemberEligibility> memberEligibity;

    public MemberEligibityRecyclerViewAdapter(List<MemberEligibility> memberEligibity)
    {
    ...
    public MemberEligibityViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_item_member_eligibity, viewGroup, false);
        return new MemberEligibityViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MemberEligibityRecyclerViewAdapter.MemberEligibityViewHolder memberEligibityViewHolder,final int i)
    {
