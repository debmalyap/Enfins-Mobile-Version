...
public class AdvancedCollection
{
    ...
    public AdvancedCollection(String searchText, String collectionPointId, int installmentAmount, int outstandingAmount, String loanId, String loanBondNo, int loanAmount, String disburseDate, String paymentSchedule) {
