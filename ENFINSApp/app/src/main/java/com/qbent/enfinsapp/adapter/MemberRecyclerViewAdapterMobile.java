...
public class MemberRecyclerViewAdapterMobile extends RecyclerView.Adapter<MemberRecyclerViewAdapterMobile.MemberViewHolder>
{
    private final List<Member> members;


    public MemberRecyclerViewAdapterMobile(List<Member> members) {
        this.members = members;
    }

    @NonNull
    @Override
    public MemberRecyclerViewAdapterMobile.MemberViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_item_member_normal, viewGroup, false);


        return new MemberRecyclerViewAdapterMobile.MemberViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MemberRecyclerViewAdapterMobile.MemberViewHolder memberViewHolder, final int i) {
