...
public class CreditSummartListRecyclerViewMobile extends RecyclerView.Adapter<CreditSummartListRecyclerViewMobile.CreditSummaryListViewHolder> implements ApiCallback
{
    private final List<CreditSummary> creditSummary;

    public CreditSummartListRecyclerViewMobile(List<CreditSummary> creditSummary)
    {
    ...
    @NonNull
    @Override
    public CreditSummartListRecyclerViewMobile.CreditSummaryListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_item_credit_summary_details_normal, viewGroup, false);
        return new CreditSummartListRecyclerViewMobile.CreditSummaryListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CreditSummartListRecyclerViewMobile.CreditSummaryListViewHolder creditSummaryListViewHolder, final int i)
    {
